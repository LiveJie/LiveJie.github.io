  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>93/111</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    this.refresh()
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.snap) {
...
<span class="cstat-no" title="statement not covered" >      this._initScrollbar()</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.pullUpLoad) {
<span class="cstat-no" title="statement not covered" >      this._initPullUp()</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.pullDownRefresh) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (wheel) {
<span class="cstat-no" title="statement not covered" >      this.items = this.scroller.children</span>
<span class="cstat-no" title="statement not covered" >      this.options.itemHeight = this.itemHeight = this.items.length ? this.scrollerHeight / this.items.length : 0</span>
<span class="cstat-no" title="statement not covered" >      if (this.selectedIndex === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        this.selectedIndex = wheel.selectedIndex</span>
      }
<span class="cstat-no" title="statement not covered" >      this.options.startY = -this.selectedIndex * this.itemHeight</span>
<span class="cstat-no" title="statement not covered" >      this.maxScrollX = 0</span>
<span class="cstat-no" title="statement not covered" >      this.maxScrollY = -this.itemHeight * (this.items.length - 1)</span>
    } else {
      this.maxScrollX = this.wrapperWidth - this.scrollerWidth
      this.maxScrollY = this.wrapperHeight - this.scrollerHeight
    }
&nbsp;
    this.hasHorizontalScroll = this.options.scrollX &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.maxScrollX &lt; 0</span>
    this.hasVerticalScroll = this.options.scrollY &amp;&amp; this.maxScrollY &lt; 0
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.hasHorizontalScroll) {
      this.maxScrollX = 0
