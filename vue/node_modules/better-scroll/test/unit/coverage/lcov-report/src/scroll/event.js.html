...
&nbsp;
  BScroll.prototype.once = function (type, fn, context = this) <span class="fstat-no" title="function not covered" >{</span>
    let fired = <span class="cstat-no" title="statement not covered" >false</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.on(type, magic)</span>
  }
&nbsp;
  BScroll.prototype.off = function (type, fn) <span class="fstat-no" title="function not covered" >{</span>
    let _events = <span class="cstat-no" title="statement not covered" >this._events[type]</span>
<span class="cstat-no" title="statement not covered" >    if (!_events) {</span>
<span class="cstat-no" title="statement not covered" >      return</span>
    }
&nbsp;
    let count = <span class="cstat-no" title="statement not covered" >_events.length</span>
<span class="cstat-no" title="statement not covered" >    while (count--) {</span>
<span class="cstat-no" title="statement not covered" >      if (_events[count][0] === fn) {</span>
<span class="cstat-no" title="statement not covered" >        _events[count][0] = undefined</span>
      }
    }
  }
&nbsp;
